/* global AFRAME, define, nipplejs, x, y, z*/
!(function (t) {
...
const style =
  "position:fixed;display:block;width:100px;height:100px;left:20px;bottom:20px;background-color:#c8c8c880;z-index:20";
function initJoystick() {
  ...
  p.setAttribute(
    "style",
    "text-align: center;margin-top:35px;font-size:12px Roboto; opacity:.5;"
  );
